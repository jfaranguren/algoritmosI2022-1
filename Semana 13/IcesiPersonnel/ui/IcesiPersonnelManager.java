...
public class IcesiPersonnelManager {
	...
	private static void registerEmployee() {
		...
		if (type == 1) {
			...
			if (personnelController.registerProfessor(name, id, contractType, degree, courses)) {
		...
		if (type == 2) {
			...
			if (personnelController.registerAdministrative(name, id, contractType, positionType)) {
